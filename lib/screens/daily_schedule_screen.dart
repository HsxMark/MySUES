...
class DailyScheduleScreenState extends State<DailyScheduleScreen> {
  ...
  String _semesterLabel() {
    ...
    return localizedScheduleName(context, _currentTable!.tableName);
  }
                            ...
                            _buildActionRow(
                              ...
                              onTap: () {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      context.l10n.courseDetailsCopied,
                                    ),
                                  ),
                                );
                              },
  ...
  Widget build(BuildContext context) {
    ...
    if (_currentTable == null) {
      return Scaffold(
        appBar: AppBar(title: Text(context.l10n.dailySchedule)),
        body: Center(
          child: Column(
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          localizedMonthTitle(context, _selectedDate),
        ...
        actions: [
          Tooltip(
            message: context.l10n.switchToWeekView,
            child: IconButton(
                ...
                return Expanded(
                  child: GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          localizedWeekdayShort(context.l10n, index + 1),
                          style: TextStyle(
                            fontSize: 13,
                            color: isSelected
