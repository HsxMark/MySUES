...
您的隐私安全对 苏伊士（My SUES）至关重要。苏伊士（以下简称“本软件”）是由上海工程技术大学在校学生独立开发的非官方工具软件。本隐私政策详细说明了我们如何收集、使用、存储和保护您的个人信息。请在使用本软件前仔细阅读。
...
*   **绝不上传**：我们承诺，**绝不**将您的账号和密码以及获取到的课表、考试、成绩、个人信息等上传至任何服务器。
*   **本地存储**：软件没有获取和存储用户账户密码的功能，通过教务系统获取的数据仅保存在手机本地，不会上传至任何服务器。

### 4. 信息的存储
*   **本地缓存**：获取到的课表、成绩等数据会保存在您手机的本地存储空间，以便您在离线状态下查看。
